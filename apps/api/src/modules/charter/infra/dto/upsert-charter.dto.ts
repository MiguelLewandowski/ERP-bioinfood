...
export class UpsertCharterDto {
  ...
  @IsOptional() @IsString() @MaxLength(200)  projectOwner?: string | null;
  @IsOptional() @IsString() @MaxLength(2000) team?: string | null;
  ...
  @IsOptional() @IsString() @MaxLength(4000) stakeholders?: string | null;
