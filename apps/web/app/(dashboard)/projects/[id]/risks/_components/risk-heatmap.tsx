    ...
    <div className="overflow-x-auto">
      <div className="inline-block min-w-[480px]">
        <div className="flex items-center mb-2">
          ...
          <div className="flex-1 text-center text-xs font-semibold text-[#575756] mb-1">IMPACTO →</div>
        </div>
        ...
        <div className="flex items-center mt-1">
          <div className="w-24 shrink-0" />
          <div className="flex-1 text-center text-xs font-semibold text-[#575756]">← PROBABILIDADE</div>
        </div>
